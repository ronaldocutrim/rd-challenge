...
1. Clone o repositório: `git clone git@github.com:ronaldocutrim/rd-challenge.git`
2. Instale as dependências: `yarn install`
3. Para instalar o projeto, execute o script `./install.sh` 
4. Inicie a aplicação: `yarn start` ou `yarn dev`
...
Desenvolvido por [Ronaldo Cutrim](https://www.linkedin.com/in/ronaldocutrim/)
